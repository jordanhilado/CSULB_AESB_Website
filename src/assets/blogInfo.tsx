export const blogInfo = [
  ...
  // {
  //   title: "Blog Post 2",
  //   subtitle: "February 1, 2022 by Jordan H.",
  //   body: "Ut sit amet leo mauris. Sed aliquam tincidunt dui, eu mollis sem semper non. Nulla a tortor imperdiet, viverra est ac, blandit leo. Donec diam purus, convallis id fermentum ac, mattis id sapien. Nullam laoreet ante et est semper, ac egestas est tincidunt. Donec non commodo mauris, id tempor est. Nam dui purus, mollis id viverra in, viverra id ipsum. Aenean id venenatis dui. Vestibulum eget elit elementum, semper nibh placerat, aliquam sapien.",
  // },
];
